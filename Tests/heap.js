...
//assert(JSON.stringify(heap2.toArray()) === JSON.stringify([1,2,3]));
//assert(heap2.insert(false) === undefined);
//assert(JSON.stringify(heap2.toArray()) === JSON.stringify([1,2,3,4]));
//assert(heap2.insert(1) === undefined);
//assert(JSON.stringify(heap2.toArray()) === JSON.stringify([1,2,3,4,5]));
//assert(heap2.insert(1) === undefined);
//assert(JSON.stringify(heap2.toArray()) === JSON.stringify([1,2,3,4,5,10]));
